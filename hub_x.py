...
# --- ESTÉTICA DARK TOTAL CON AJUSTE DE COLOR ---
st.markdown("""
    <style>
    /* Fondo general negro y letras blancas para el cuerpo */
    ...
    /* MODIFICACIÓN: Letras NEGRAS solo para la barra lateral (Sidebar) */
...
# --- LOBBY ---
    ...
    # LA BARRA LATERAL (SIDEBAR) AHORA TENDRÁ LETRAS NEGRAS
